...
from Bgt.utils.formatters import check_duration, convert_bytes, get_readable_time, seconds_to_min
        ...
        async def down_load():
                        ...
                        if high == check:
                            try:
                                await mystic.edit_text(
                                    text="<u><b>{0} ᴅᴏᴡɴʟᴏᴀᴅᴇʀ</b></u>\n\n<b>ғɪʟᴇ sɪᴢᴇ :</b> {1}\n<b>ᴄᴏᴍᴘʟᴇᴛᴇᴅ :</b> {2}\n<b>ᴘᴇʀᴄᴇɴᴛᴀɢᴇ :</b> {3}%\n\n<b>sᴘᴇᴇᴅ :</b> {4}/s\n<b>ᴇᴛᴀ :</b> {5}".format(
                                        app.mention, total_size, completed_size, percentage[:5], speed, eta),
                                    reply_markup=upl,
                                )
                                checker[counter] = 100
                            except:
            ...
            try:
                ...
                try:
                    ...
                    elapsed = "0 sᴇᴄᴏɴᴅs"
                await mystic.edit_text("sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ᴘʀᴏᴄᴇssɪɴɢ ғɪʟᴇ\n\n<b>ᴛɪᴍᴇ ᴇʟᴀᴘsᴇᴅ :</b> {0}".format(elapsed))
            except:
                await mystic.edit_text("ғᴀɪʟᴇᴅ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇᴅɪᴀ ғʀᴏᴍ ᴛᴇʟᴇɢʀᴀᴍ ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ...")
