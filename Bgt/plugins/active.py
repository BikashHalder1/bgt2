...
from Bgt.utils.database import get_active_chats, get_active_video_chats, remove_active_chat, remove_active_video_chat
...
@app.on_message(filters.command(["avc", "activevoice"]) & SUDOERS)
async def activevc(bot: app, message: Message):
    ...
    if not text:
        ...
        await mystic.edit_text(f"<b>» ʟɪsᴛ ᴏғ ᴄᴜʀʀᴇɴᴛʟʏ ᴀᴄᴛɪᴠᴇ ᴠᴏɪᴄᴇ ᴄʜᴀᴛs :</b>\n\n{text}", disable_web_page_preview=True)
...
async def activevi_(bot: app, message: Message):
    ...
    if not text:
        ...
        await mystic.edit_text(f"<b>» ʟɪsᴛ ᴏғ ᴄᴜʀʀᴇɴᴛʟʏ ᴀᴄᴛɪᴠᴇ ᴠɪᴅᴇᴏ ᴄʜᴀᴛs :</b>\n\n{text}", disable_web_page_preview=True)
...
async def littleac(_, message: Message):
    ...
    await message.reply_text("• ʙᴏᴛ ᴀᴄᴛɪᴠᴇ ᴄʜᴀᴛs ɪɴғᴏ • 🔊\n•━━━━━━━━━━━━━━━━━━•\n🎧 ᴀᴜᴅɪᴏ 🎧 » {0} ᴀᴄᴛɪᴠᴇ\n•───────•\n🎥 ᴠɪᴅᴇᴏ 🎥 » {1} ᴀᴄᴛɪᴠᴇ\n•──────•".format(ac_audio, ac_video), quote=True)
