...
async def admins(_, message: Message, chat_id):
    ...
    if state.isnumeric():
        ...
        if 1 <= state <= 10:
            ...
            return await message.reply_text("ʟᴏᴏᴘ ᴇɴᴀʙʟᴇᴅ ʙʏ {0} ​ ꜰᴏʀ **{1}** ᴛɪᴍᴇs.\n\nʙᴏᴛ ᴡɪʟʟ ɴᴏᴡ ʀᴇᴘᴇᴀᴛ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ꜰᴏʀ **{1}** ᴛɪᴍᴇs ​".format(message.from_user.mention, state))
        else:
            return await message.reply_text("ᴘʟᴇᴀsᴇ ᴜsᴇ ɴᴜᴍʙᴇʀs ʙᴇᴛᴡᴇᴇɴ 1-10 ꜰᴏʀ ʟᴏᴏᴘ ᴘʟᴀʏ ​")

    elif state.lower() == "enable":
        await set_loop(chat_id, 10)
        return await message.reply_text("ʟᴏᴏᴘ ᴇɴᴀʙʟᴇᴅ ʙʏ {0} ​ ꜰᴏʀ **{1}** ᴛɪᴍᴇs.\n\nʙᴏᴛ ᴡɪʟʟ ɴᴏᴡ ʀᴇᴘᴇᴀᴛ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ꜰᴏʀ **{1}** ᴛɪᴍᴇs ​".format(message.from_user.mention, 10))
